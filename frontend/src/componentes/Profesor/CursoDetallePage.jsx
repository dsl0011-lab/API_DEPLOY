    ...
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <form onSubmit={crearTarea} className="flex gap-2">
          <input className="border p-2 rounded flex-1" placeholder="Título de la tarea"
      ...
      <section className="space-y-3">
        ...
        <form onSubmit={matricular} className="flex gap-2">
          <input className="border p-2 rounded w-40" placeholder="id usuario"
                 value={alumnoId} onChange={e=>setAlumnoId(e.target.value)} />
