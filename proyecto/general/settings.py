...
# COOKIE_DOMAIN = "api-deploy-wyep.onrender.com"

# # Dominio base de tu API
# BASE_COOKIE_DOMAIN = COOKIE_DOMAIN

# SESSION_COOKIE_DOMAIN = BASE_COOKIE_DOMAIN
# CSRF_COOKIE_DOMAIN = BASE_COOKIE_DOMAIN
